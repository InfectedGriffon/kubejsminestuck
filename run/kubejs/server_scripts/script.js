...
onEvent('recipes', event => {
	...
	//adding and removing grist costs
	...
	//using grist.of and gristset.from
	event.recipes.minestuckGristCost("minecraft:dirt", Grist.of("build", 3))
	event.recipes.minestuck.grist_cost("minecraft:coarse_dirt", 
		GristSet.from(  Grist.of("build",2),  Grist.of("amber",4)  ))
